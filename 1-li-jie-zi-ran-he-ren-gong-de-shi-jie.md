...
计算机无疑是最适合用于模拟的工具。它非常的多变，因为其行为绝大部分都是组织性质而非内部构造性质。其运行速度可以让我们大致知道其内部构造的一部分必然是快速的。除了这点之外，计算机和其硬件几乎没有必要的联系。计算机是由基本功能构件组织起来的，其行为完全由构件的组织关系所决定。
...
前文中指出人类智能是由实体符号系统产生的。与之相对的是，现代经济学理论和新古典学派的经济学理论把人当做全知的理性系统。这是一个相当大胆的假设。这些经济理论注重研究人思维以外的经济环境，并假设人作为个体能够根据环境信息制定出最优策略，它们的重点是对这些最优策略的定义与研究。

经济学理论对符号系统设定理性上限的看法是务实的，甚至是投机的。在通过“一般均衡”和“理性预期”等方式研究适应手段的研究中，内部信息处理系统的能力上限几乎被无视了。在另一方面，在有关市场基本原理和很多“在不确定环境中作决策"的理论中，理性的内部运行机制得到了比较正式的关注。

在第二章会讲述无视理性上限的例子，也会讲述关心理智上限的例子。我们将从经济学中的理想化设定（以及对这些设定的一些批判）过渡到第三和第四章对人类大脑理智性能上限的分析讨论。
